...
<form class="form" action="SignUp" method="post">
 ...
 <!--  <div class="form-group">
  ...
  <input type="submit" value="SignUp">-->
   <div class="controls">
   <button id="signup" name="signUp" class="btn orange_button" value="SignUp">Sign Up</button>
   </div>
</form>
...
<div class="row">
<h2><strong>3 Reasons</strong> - Why uFired?</h2>

<ul>
<li><strong>Lorem ipsum dolor</strong> 
Amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor</li>
<li><strong>Lorem ipsum dolor</strong> 
Amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor</li>
<li><strong>Lorem ipsum dolor</strong> 
Amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor</li>
