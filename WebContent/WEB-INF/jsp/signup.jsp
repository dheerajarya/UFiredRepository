				...
				<div class="navbar navbar-default" role="navigation"
					...
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand logo" href="<%=request.getContextPath()%>"><img
						...
						<div class="collapse navbar-collapse" id="navbar">
							...
							<ul class="nav navbar-nav">
								<!-- <li><a class="active" href="index.jsp"> Talent </a></li>
								<li><a href="#"> Employer </a></li> -->
								<li> <a href="<%=request.getContextPath()%>/Contact?action=Contact" name="Contact">Contact</a></li>
							</ul>
							<ul class="nav navbar-nav navbar-right float-right">
								<li class="left">
									<%-- <a href="<%=request.getContextPath()%>/Login" name="Login">Login</a>      --%>

									<a href="<%=request.getContextPath()%>/Login?action=LoginPage"
									name="Login">Login</a> <!-- <a href="#signup" data-toggle="modal" data-target=".bs-modal-sm"><i class="ti-lock"></i>  Login</a> -->
								</li>
								<li class="right">
									...
									<a
									href="<%=request.getContextPath()%>/SignUp?action=SignUpPage"
					...
					<ul class="wpb-mobile-menu">
						<li><a class="active" href="index.jsp">Talent</a></li>
						<li><a href="about.jsp">Employer</a></li>
						<li><a href="#">Contact</a></li>

						<li class="btn-m"><a href="job_listing.jsp"><i
								class="ti-pencil-alt"></i> Post A Job</a></li>
						<li class="btn-m"><a href="my-account.jsp"><i
			...
			<div class="container-fluid grey">
				<div class="container">
					<div class="row">
						...
						<div
							class="col-md-6 col-ld-6 col-xs-12 col-sm-6 white employee_tab">



							<div class="tab-content">

								<h3>Get started and find your dream job today!</h3>
								...
								<form class="form" action="SignUp" method="post">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="email"
											...
											value=<%=request.getParameter("email") %> maxlength="60"
											required>
										<% }else {%>
										<input type="text" class="form-control" name="email"
											id="email" placeholder="Email" maxlength="60" required>
										<% } %>
									</div>
									<div class="form-group">
										<!--    <input type="text" class="form-control"  name = "fName" id="formGroupExampleInput2" placeholder="First name" 
    maxlength="40" required> -->

										<% if(request.getParameter("fName") != null){%>
										<input type="text" class="form-control" name="fName"
											id="fName" placeholder="First Name"
											value=<%=request.getParameter("fName") %> maxlength="40"
											required>
										<% }else {%>
										<input type="text" class="form-control" name="fName"
											id="fName" placeholder="First Name" maxlength="40" required>
										<% } %>
									</div>
									<div class="form-group">
    	...
    	maxlength="40" required> -->
										...
										<input type="text" class="form-control" name="lName"
											...
											value=<%=request.getParameter("lName") %> maxlength="40"
											required>
										<% }else {%>
										<input type="text" class="form-control" name="lName"
											id="lName" placeholder="Last Name" maxlength="40" required>
										<% } %>
									</div>
									<div class="form-group">
										<!--  <input type="text" class="form-control" id="phone" name = "telephone" placeholder="Phone" 
    	maxlength="15" required> -->

										<% if(request.getParameter("telephone") != null){%>
										<input type="text" class="form-control" name="telephone"
											id="telephone" placeholder="Telephone"
											value=<%=request.getParameter("lName") %> maxlength="15"
											required>
										<% }else {%>
										<input type="text" class="form-control" name="telephone"
											id="telephone" placeholder="Telephone" maxlength="40"
											required>
										<% } %>
									</div>
									<div class="form-group">
										<input id="password" name="password" class="form-control"
											placeholder="Password" type="password" maxlength="30"
											required>
									</div>
									<!--  <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <input type="text" class="form-control" name = "zipCode" id="zipcode" 
     placeholder="zipcode" onkeypress="return isNumber(event)" required>
  </div> -->

									<!--  <button type="button" class="btn  orange_button" value="SignUp">Submit</button>
  <input type="submit" value="SignUp">-->
									<div class="controls">
										<button id="signup" name="signUp" class="btn orange_button"
						...
						<div class="col-md-6 col-ld-6 col-xs-12 col-sm-6 reasons">
							...
							<div class="row">
								<h2>
									<strong>3 Reasons</strong> - Why uFired?
								</h2>

								<ul>
									<li><strong>Lorem ipsum dolor</strong> Amet, consectetuer
										adipiscing elit. Aenean commodo ligula eget dolor</li>
									<li><strong>Lorem ipsum dolor</strong> Amet, consectetuer
										adipiscing elit. Aenean commodo ligula eget dolor</li>
									<li><strong>Lorem ipsum dolor</strong> Amet, consectetuer
										adipiscing elit. Aenean commodo ligula eget dolor</li>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-3 col-xs-12">
								<div class="site-info">
									<a href="#"> Privacy</a> <a href="#"> Terms</a><a href="#">
										SItemap</a>
								</div>
							</div>
						</div>
