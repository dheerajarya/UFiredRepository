...
<html lang="en">
  ...
  <body>  
            ...
            <div class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
              <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right float-right">
                  ...
                  <a href="<%=request.getContextPath()%>/Login?LoginPage=LoginPage" name="Login">Login</a>
</li>
                 <li class="right">
                 <%--  <a href="<%=request.getContextPath()%>/SignUp" name="SignUp">SIGN UP</a> --%>
                  <!-- <button class="btn signup" href="signup.jsp"></i>  Signup</button> -->
                  <a href="<%=request.getContextPath()%>/SignUp?SignUpPage=SignUpPage" name="SignUp">SIGN UP</a> 
        </li>         
      ...
      <div class="container">Forgot Password</div>
      </div>
...
<form action="ForgotPasswordController" method="post">
  ...
  <label for="errorMessage" style="text-align: center; color:red;">${errorMessage}</label>
            <div class="control-group">
              <div class="controls">
                <button id="submit" name="submit" class="btn orange_button" value="ForgotPasswordController">Submit</button>                
              </div>
